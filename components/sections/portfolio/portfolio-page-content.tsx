...
const projects = [
  ...
  },
  {
    ...
    year: "2025",
    visualClass: styles.visualThree,
  },
  {
          ...
          <div className={styles.grid}>
            {projects.map((project, index) => (
              <article key={project.title} className={styles.project}>
                <div
                  className={`${styles.visual} ${project.visualClass}`}
                  aria-hidden="true"
                >
